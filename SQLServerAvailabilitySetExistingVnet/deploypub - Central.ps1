$resourceGroupName = 'GS-POC-Pub-Central'
$resourceGroupLocation = "Central US"
$templateFile = 'E:\GitLocal\ARM\SQLServerAvailabilitySetExistingVnet\template.json'
$templateParm = 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersPubCentral .json'
$subscription = 'TAMZ_MS'
# ii 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersPubCentral .json'
