$resourceGroupName = 'GS-POC-Dist-Central'
$resourceGroupLocation = "Central US"
$templateFile = 'E:\GitLocal\ARM\SQLServerAvailabilitySetExistingVnet\template.json'
$templateParm = 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersDistributorCentral.json'
$subscription = 'TAMZ_MS'
# ii 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersDistributorCentral.json'
