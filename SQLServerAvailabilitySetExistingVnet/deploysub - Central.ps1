$resourceGroupName = 'GS-POC-Sub-Central'
$resourceGroupLocation = "Central US"
$templateFile = 'E:\GitLocal\ARM\SQLServerAvailabilitySetExistingVnet\template.json'
$templateParm = 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersSubCentral.json'
$subscription = 'TAMZ_MS'
# ii 'E:\Demos\GS-SQLRepl\SQLAvailabilitySetExitingVNetparametersSubCentral.json'
