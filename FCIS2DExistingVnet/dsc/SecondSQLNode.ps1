...
"@
        ...
        Script  AddProbeToSQLClusterResource
        {
            ...
            SetScript  = {
                            ...
                            Get-ClusterResource 'SQL IP*'| Set-ClusterParameter -Multiple @{"Address"=$using:SQLStaticIP;"ProbePort"=59999;"SubnetMask"=$using:ClusterIPSubnetMask;"Network"="Cluster Network 1";"EnableDhcp"=0}
                        }
            TestScript = {
