$resourceGroupName = 'GS-POC-Pub-East'
$resourceGroupLocation = "East US"
$templateFile = 'E:\GitLocal\ARM\AlwaysOnExistingVnet\template.json'
$templateParm = 'E:\Demos\GS-SQLRepl\AlwaysOnExitingVNetparametersPub.json'
$subscription = 'TAMZ_MS'
# ii 'E:\Demos\GS-SQLRepl\AlwaysOnExitingVNetparametersPub.json'
